...
class CartOrderSummary extends ConsumerStatefulWidget {
  const CartOrderSummary({super.key});

  @override
  ConsumerState createState() => _CartOrderSummaryState();
}

class _CartOrderSummaryState extends ConsumerState<CartOrderSummary> {
  @override
