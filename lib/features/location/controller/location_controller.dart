...
final getFavPracticesProvider =
    StreamProvider.family((ref, UserInfoModel user) {
...
class LocationController {
  ...
  LocationController({required LocationRepository repo}) : _repo = repo;
  ...
  Future<String> uploadPrescriptionsToPharmacy(HealthcareCentreInfo pharmacy,
    ...
    final res =
        await _repo.uploadPrescriptionsToPharmacy(pharmacy, prescriptions);
    res.fold((l) {
