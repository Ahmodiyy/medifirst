...
import 'package:medifirst/features/location/presentation/screens/doctor_maps_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        }, child: const ExploreCategoryItem(svg: 'assets/icons/explore/consultant.png', title: 'Consultation', topColor: Palette.consultationGreen, bottomColor: Palette.consultationDarkGreen,)),
