...
class AuthController extends StateNotifier<bool> {
  ...
  Future<void> registerUserWithNumber(String mobile, String name,
      String surname, BuildContext context) async {
    try {
      final res =
  ...
  Future<void> loginUserWithNumber(String mobile, BuildContext context) async {
    try {
      final res =
      await _repo.loginUserWithNumber(mobile, context);
      res.fold((l) {
        throw Exception(l.error);
      }, (r) async {await updateUserState();});
    } catch (e) {
      rethrow;
    }
  }
...
final userProvider = StateNotifierProvider<UserNotifier, UserInfoModel?>((ref) => UserNotifier());
...
final doctorProvider = StateNotifierProvider<DoctorNotifier, DoctorInfo?>((ref) => DoctorNotifier());
...
final pharmacyProvider = StateNotifierProvider<PharmacyNotifier, HealthcareCentreInfo?>((ref) => PharmacyNotifier());
