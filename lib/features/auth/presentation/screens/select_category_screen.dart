        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                (widget.isNewUser)?
                'Registering As': 'Select Category',
                style:
              ...
              InkWell(
                ...
                child: OutlineCategoryButton(label: 'Patient', selected: (picked == Constants.patientCategory),),
              ),
              (size.height * 32 / 852).pv,
              InkWell(
                onTap: () => selectCategory(Constants.doctorCategory),
                child: OutlineCategoryButton(label: 'Doctor', selected: (picked == Constants.doctorCategory),),
              ),
              (size.height * 32 / 852).pv,
              // InkWell(
