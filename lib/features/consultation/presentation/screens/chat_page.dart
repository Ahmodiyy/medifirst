...
class ChatPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ChatPage> createState() => _DoctorChatPageState();
}

class _DoctorChatPageState extends ConsumerState<ChatPage> {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          CircleAvatar(
            radius: 20,
            backgroundImage: NetworkImage(widget.appt.doctorImageURL),
          ),
          SizedBox(width: 12),
          Expanded(
            child: Column(
  ...
  Widget _buildMessageItem(DocumentSnapshot doc) {
    ...
    bool isMe = data['userId'] == _user?.uid;
