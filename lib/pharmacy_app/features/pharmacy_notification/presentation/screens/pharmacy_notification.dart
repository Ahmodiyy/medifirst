...
class PharmacyNotificationScreen extends ConsumerStatefulWidget {
  const PharmacyNotificationScreen({super.key});

  @override
  ConsumerState createState() => _PharmacyNotificationScreenState();
}

class _PharmacyNotificationScreenState extends ConsumerState<PharmacyNotificationScreen> {
  @override
  Widget build(BuildContext context) {
    final Size size = MediaQuery.sizeOf(context);
    final user = ref.watch(pharmacyProvider);
    return Scaffold(
      ...
      body: SizedBox(
        ...
        child: ref.watch(getNotificationsProvider(user!.pId)).when(
          data: (notifications) {
