...
class AddressUnderlinedTextField extends StatelessWidget {
  ...
  const AddressUnderlinedTextField({super.key, required this.controller, required this.latLngCallback, required this.clickCallback, required this.focus});
  ...
  Widget build(BuildContext context) {
    ...
    return GooglePlaceAutoCompleteTextField(
      ...
      googleAPIKey: (Platform.isAndroid)
          ? Credentials.androidAPIKey
          : Credentials.iosAPIKey,
